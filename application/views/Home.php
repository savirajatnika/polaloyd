...
<link href="<?php echo base_url()?>assets/gallery/vendor/font-awesome/css/ubuntu.min.css" rel="stylesheet" type="text/css">
...
@font-face {
    ...
    src: url(<?php echo base_url()?>assets/fonts/ubuntu-regular-webfont.ttf);
}

@font-face {
    font-family: ubuntu-regular-italic-webfont;
    src: url(<?php echo base_url()?>assets/fonts/ubuntu-regular-italic-webfont.ttf);
}

@font-face {
    font-family: ubuntu-medium-webfont;
    src: url(<?php echo base_url()?>assets/fonts/ubuntu-medium-webfont.ttf);
}

@font-face {
    font-family: ubuntu-medium-italic-webfont;
    src: url(<?php echo base_url()?>assets/fonts/ubuntu-medium-italic-webfont.ttf);
}

@font-face {
    font-family: ubuntu-bold-webfont;
    src: url(<?php echo base_url()?>assets/fonts/ubuntu-bold-webfont.ttf);
}

@font-face {
    font-family: ubuntumono-bold-webfont;
    src: url(<?php echo base_url()?>assets/fonts/ubuntumono-bold-webfont.ttf);
}
</style>
...
<!--..................................................HEADER..................................................-->
    <nav role="navigation" class="navbar navbar-default" style="top: 0; z-index: 50000; position: fixed; width: 100%; height: 55px;">
        ...
        <div class="navbar-header">
            ...
            <a href="#home" class="navbar-brand" style="border: 2px #7F8984; border-radius: 40px; font-family: ubuntumono-bold-webfont; font-size: 24px; background-color: #F2E682; opacity: 1;">P O L A L O Y D</a>
        </div>
        <!-- Collection of nav links and other content for toggling -->
        <div id="navbarCollapse" class="collapse navbar-collapse" style="float: right; color: #7F8984;">
          <ul class="nav navbar-nav">
            <li><a href="#about" class="w3-bar-item w3-button" style="font-family: ubuntu-regular-webfont; color: #FFFFFF;">About</a> </li>
            <li><a href="#portfolio" class="w3-bar-item w3-button" style="font-family: ubuntu-regular-webfont; color: #FFFFFF;">Gallery</a> </li>
            <li><a href="#contact" class="w3-bar-item w3-button" style="font-family: ubuntu-regular-webfont; color: #FFFFFF;">Contact</a></li>
          </ul>
        </div>
    </nav>                           
...
<div class="w3-content" id="about" style="max-width:1600px; max-height: 800px;">
  ...
  <div class="w3-row w3-padding-64" style="background-color: #162C49;">
    ...
    <div align="center" class="w3-col m6 w3-padding-large">
      <h1 class="w3-center" style="font-family: ubuntu-bold-webfont; color: white; padding-right: 100px;">P O L A L O Y D</h1><br>
      <h2 class="w3-center" style="font-family: ubuntu-regular-webfont; color: white; padding-right: 100px;"><strong>Jasa cetak foto polaroid</strong></h2>
      <p class="w3-large" style="text-align: justify; font-family: ubuntu-regular-webfont; color: white; padding-right: 100px;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading" style="font-family: ubuntu-bold-webfont;margin-top:-100px;">Gallery</h2>
...
<!-- Contact Section -->
      <div class="w3-container">
        ...
        <h1 style="font-family: ubuntu-bold-webfont;color: white; margin-top:-70px;text-align: center; font-size: 35px; color: white;">Contact Us</h1><br>
          <p style="font-family: ubuntu-regular-webfont; font-size: 20px;text-align: center; color: white"> Sampaikan pertanyaan anda melalui form dibawah ini: </p>
          <p class="w3-text-blue-grey w3-large"></p>
        
    <?php echo form_open(site_url('My_Controller/create'));?>
        <form method="POST" name="komentar">
          <div class="col-sm-5 col-sm-offset-1">
            <label style="font-family: ubuntu-medium-webfont; font-size: 19px;margin-top:0px;text-align: center; color: white">Nama</label>
              <p><input class="w3-input" type="text" placeholder="Ex: John" required name="Name" ></p>
            <label style="font-family: ubuntu-medium-webfont; font-size: 19px;margin-top:4px;text-align: center; color: white">Email</label>
              <p><input class="w3-input" type="text" placeholder="Ex: John@gmail.com" required name="Email"></p>
            <label style="font-family: ubuntu-medium-webfont; font-size: 19px;margin-top:4px;text-align: center; color: white">Nomor Telepon</label>
              <p><input class="w3-input" type="text" placeholder="Ex: 081122223333" required name="number"></p>
            <label style="font-family: ubuntu-medium-webfont; font-size: 19px;margin-top:4px;text-align: center; color: white">Date</label>
          ...
          <div class="col-sm-5">
            <label style="font-family: ubuntu-medium-webfont; font-size: 19px;text-align: center; color: white"> Pesan</label>
               <p><textarea class="w3-input" type="text" placeholder="Masukkan pesan anda disini" required name="Message" rows="11"></textarea></p> 
               
          </div>
            <p style="color: white; font-family: ubuntu-medium-webfont; margin-top:30px;margin-left:425px; width: 50px; text-align: center;"><br><button type="submit" name="submit" value="Submit" class="w3-button w3-amber">Send Message</button></p>
