        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <table align="center" style="width: 100%;">
                    ...
                    <form method="post" action="<?php echo base_url()?>index.php/My_Controller/delete_slider"> <!-- delete banyak row -->
                    <tbody style="text-align: center;">
                        ...
                        <td align="center">
                            ...
                            <a href="<?php echo base_url()."index.php/My_Controller/deleteslider".$b['ID_slider']; ?>"><button class="btn-danger" style="border: solid 1px; margin-top: 10px; margin-bottom: 10px;">Delete</button></a>
                        </td>
                        </tr>
                        <?php } ?>
                    </tbody>
